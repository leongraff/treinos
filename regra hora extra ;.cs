...
@=== Até 20 H.E 55% (421 diurna e 422 Noturna)                              ===@
@=== de 20:01 a 45 60% (413 diurna e 414 Noturna)                           ===@
@=== de 45:01 acima 100% (303 diurna e 304 Noturna)                         ===@
@==============================================================================@
...
Se(xQtdHor > 2700){ @=== Se for maior que 45 horas, considera 100% ===@
  @=== H.E Diurna ===@
...
@=== Se for menor que 45 horas, e maior que 20 ===@
Senao Se((xQtdHor < 2700) e (xQtdHor > 1200)) { 
  @=== Trata a 55% diurna ===@
  Se(HorSit[421] > 0){
    @=== Verifica se a soma das horas mas a situação normal ultrapassa 45 ===@
    Se((xQtdHor + HorSit[421]) > 2700){
  ...
  Se(HorSit[422] > 0){
    ...
    Senao Se((xQtdHor + HorSit[422]) > 2700){
...
@=== Se a soma das situações com o saldo do perído for maior que 20 h.e ===@
Senao Se((xQtdHor + HorSit[421] + HorSit[422]) > 1200){
  @=== Valida H.E 55 Diurna ===@
  Se(HorSit[421] > 0){
    @=== Se somado com diurna é maior que 20 horas ===@
    Se((xQtdHor + HorSit[421]) > 1200){
  ...
  Se(HorSit[422] > 0){
    ...
    Senao Se((xQtdHor + HorSit[422] > 1200)){
      @=== Separa horas 55% e 60% ===@
      xDif55 = 1200 - xQtdHor;
...
@==============================================================================@
@=== Regra de apuração converte as situações de H.E conforme tabela abaixo: ===@
@=== Até 20 H.E 55% (423 diurna e 424 Noturna)                              ===@
@=== de 20:01 a 45 60% (417 diurna e 418 Noturna)                           ===@
@=== de 45:01 acima 100% (403 diurna e 404 Noturna)                         ===@
@==============================================================================@
@=== Duas condições para a regra funcionar adequadamente:                   ===@
@=== 1- A situação de H.E em dia "normal" (exceção de DSRS e Feriados) deve ===@
...
Senao Se((xQtdHor < 2700) e (xQtdHor > 1200)) { 
  ...
  Se(HorSit[424] > 0){
    ...
    @=== Verifica se a soma das horas com as horas noturnas é maior que 45 ===@
    Senao Se((xQtdHor + HorSit[424]) > 2700){
      @=== Se for maior a diferença em 60% noturna e o excedente em 100% noturna ===@
      xDif60 = 2700 - xQtdHor;
...
@=== Se a soma das situações com o saldo do perído for maior que 20 h.e ===@
Senao Se((xQtdHor + HorSit[423] + HorSit[424]) > 1200){
  @=== Valida H.E 55 Diurna ===@
  Se(HorSit[423] > 0){
    @=== Se somado com diurna é maior que 20 horas ===@
    Se((xQtdHor + HorSit[423]) > 1200){
      @=== Separa horas 55% e 60% ===@
      xDif55 = 1200 - xQtdHor;
  ...
  Se(HorSit[424] > 0){
    ...
    Senao Se((xQtdHor + HorSit[424] > 1200)){
      @=== Separa horas 55% e 60% ===@
      xDif55 = 1200 - xQtdHor;
